...
function DocGettingStarted() {
    ...
    return (
        ...
        <P>Lv2Cairo requires the following packages to be installed.</P>
...
`)}
    ...
    <P>Lv2Cairo was built using Visual Studio Code. If you open the folder in Visual Studio code, with CPP and CMake extensions installed, 
    </P>
    <P>If you prefer not to use Visual Studio Code, you can use the following commands to build Lv2Cairo.</P>
