...
function WhyLV2C() {
    ...
    return (
        <Box className={"page_column"}>
            <Typography variant="h4" paragraph>Why Lv2Cairo?</Typography>
            ...
            <P>
                ...
                Plugins that try to load an incompatible UI library will not load. Lv2Cairo has been designed principally
            ...
            <P>
                ...
                provide widgets or UI controls of any kind. Lv2Cairo is intended to bridge that gap. 
            </P>
            <P>
                ...
                problem. As more hosts integrate SUIL, Lv2Cairo will become less useful.
            </P>
            ...
            <P>
                The Lv2Cairo library is MIT licensed (with LGPL dependencies on Cairo, and PangoCairo). End of that problem.
            </P>
            <Typography variant="h6" paragraph>Lv2Plugin's Place in the Library</Typography>
            <P> It's also worth discussing the Lv2Plugin's place in the Lv2Cairo library. </P>
            <P>
                ...
                It was originally brought in to allow implementaton of a test plugin for Lv2Cairo. But in the interest of providing a complete solution
                for writing LV2 plugins, it graduated to become a public feature of the Lv2Cairo library.</P>
            ...
            <P>Doing this properly would require a fair bit of work. The current source is covered by automated and manual testing in the 
                ToobAmp project. Re-implemenation and refactoring would require test coverage in the Lv2Cairo project. So a decision was made to 
